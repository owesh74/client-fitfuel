...
const Login = () => {
  ...
  // 3. This function now uses the central login logic
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // The login function handles success toast and navigation automatically
    } catch (err) {
        ...
        <div className="bg-white py-8 px-8 rounded-2xl border border-gray-200 shadow-lg">
          ...
          <div className="mt-8 text-center">
            ...
            <div className="mt-4">
              <Link 
                to="/signup" 
                className="w-full inline-flex justify-center items-center px-4 py-3 border border-gray-200 rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 font-semibold"
              >
                Create new account
              </Link>
            </div>
